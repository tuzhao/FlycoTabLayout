...
public class CommonTabLayout extends FrameLayout implements ValueAnimator.AnimatorUpdateListener {
     ...
     * 关联数据支持同时切换fragments
     */
    public void setTabData(ArrayList<CustomTabEntity> customTabEntities, FragmentActivity fa, int containerViewId, ArrayList<Fragment> fragments) {
        mFragmentChangeManager = new FragmentChangeManager(fa.getSupportFragmentManager(), containerViewId, fragments);
        setTabData(customTabEntities);
    }

    public void setTabData(ArrayList<CustomTabEntity> customTabEntities, FragmentActivity fa, int containerViewId, ArrayList<Fragment> fragments, ArrayList<String> tags) {
